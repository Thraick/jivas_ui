...
export default function DeletepromptSetDialog(props: { res: PromptsType, stateName: string, agentName: string, label: string }) {
    ...
    function handleSubmit() {
        ...
        // }
        submit(formData, { method: "post", action: `/agents/${id}/states/${sid}/prompts/delete` });
    }
            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogHeader className="justify-center items-center">
                        <DialogTitle className="capitalize">Delete {props.agentName} {props.stateName} prompt</DialogTitle>
                    </DialogHeader>
                    <DialogDescription className="normal-case">{props.res.prompt}</DialogDescription>
                    <DialogFooter>
                        <DialogClose asChild>
