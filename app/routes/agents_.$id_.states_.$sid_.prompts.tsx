...
import { PromptsType } from "../utils/dataTypes";
...
export default function faqs() {
    ...
    const loaderData = useLoaderData() as PromptsType[];
    // const loaderData = rdata as PromptsType[];
    ...
    const handleCreateTransition = () => {
        ...
        localStorageService.setItem('newPrompt', searchTerm)
        navigate("new")
    }
        ...
        <>
            <div className="flex-1 justify-between flex flex-col h-screen bg-gray-100">
                <div className="bg-background shadow-md p-4 flex justify-between items-center">
                    <h1 className="text-3xl capitalize">{stateName.replace(/_/g, " ")} Prompts</h1>
                    ...
                    <div>
                        <nav className="">
                            ...
                            <ol className="list-reset flex">
                                ...
                                <li className="text-neutral-500 dark:text-neutral-400">Prompts</li>
                            </ol>
                        </nav>
                    </div>
                    <Button variant={'secondary'} onClick={handleCreateTransition} className="bg-blue-400" ><Plus className="mr-2 h-4 w-4" /> New Prompt</Button>
                </div>
                        ...
                        <div className="overflow-y-auto max-h-3/4 scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch flex-grow">
                            ...
                            <div
                                ...
                                <div className="flex flex-col items-center justify-center">
                                    <h1 className="uppercase">Create New Prompt</h1>
                                    ...
                                    .map((res: PromptsType) => (
                                        ...
                                        <div key={res.id} className="bg-background max-w-4xl mx-auto hover:bg-card shadow-md rounded px-8 py-4  mb-4">
                                            <div className="flex justify-between items-center items-start">
                                                    <h3 className="text-md capitalize mr-2">{res.prompt}</h3>
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    <div>
                                                        <Link to={`/agents/${id}/states/${sid}/prompts/${res.id}`}>
                                                            <Button variant="outline">
                                                                <Edit className="mr-2 h-4 w-4" /> Edit
                                                            </Button>
                                                        </Link>
                                                    </div>
                                                    <DeletepromptSetDialog res={res} stateName={stateName} agentName={agentName} label={""} />
                                                </div>
                                            </div>
                                        </div>
