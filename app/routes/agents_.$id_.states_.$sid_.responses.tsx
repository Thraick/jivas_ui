...

                {
                    filteredSearch.length === 0
                        ...
                        <div className="overflow-y-auto mt-10 max-h-3/4 scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch flex-grow">
                            ...
                            <div className="bg-background max-w-4xl mx-auto hover:bg-card shadow-md rounded px-8 pt-6 pb-8 mb-4 cursor-pointer">
                                <div className="flex flex-col items-center justify-center">
                                    <h1 className="uppercase">Create New Response</h1>
                                    <p className="case-normal">this is a new response. this is just a test.</p>
                                    <Plus className="mt-2" />
                                </div>
                            </div>
                        </div>
